...
import hmda.validation.engine.TsEngine2020._
import org.scalatest.{ MustMatchers, PropSpec }
import org.scalatestplus.scalacheck.ScalaCheckPropertyChecks

class TsEngine2020Spec extends PropSpec with ScalaCheckPropertyChecks with MustMatchers {
  val tsGen2020Yearly = tsGen.map(_.copy(year = 2020))
